					...
					<div class="page-content">
							...
							if (isset($_GET['backresult']))
						{
							...
							if ($backresult ==  "1") {
								...
								$result=mysqli_query($sqlcon, "SELECT * FROM `students` where `stid`=$profileid");
								while($stinfores = mysqli_fetch_assoc($result))
															{	
							...
							<div class="col-xs-12">
								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												<span class="profile-picture">
													<img height="200" width="200" id="avatar" onerror="this.src='assets/images/avatars/Student.png'" src="assets/images/avatars/students/<?php echo $stinfores['stid'] ;?>.jpg" />
												</span>
												<div class="space-4"></div>
											</div>
										</div>
										<div class="col-xs-12 col-sm-9">
										<form method="post" action="assets/redi/editst.php?profileid=<?php echo $profileid?>" method="post">
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> الكود </div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> رقم تليفون آخر </div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> صفة ولي الأمر </div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name">  الترم </div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name">  الجروب </div>
												...
												<div class="profile-info-row">
													...
													<div class="col-sm-2">
														<input type="hidden" name="stbalance" value="<?php echo $stinfores['stbalance'] ;?>">
															<?php 
																require 'assets/redi/sqlcon.php';
																if (isset($_SESSION['authenticate']))
																	{	
																		...
																		if($authenticate = "true"):
																			?>
																				<input value="<?php echo $stinfores['stbalance'] ;?>" type="text" class="form-control" name="stbalance" >
																			<?php
																		endif;
																	}
																else
													...
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<span id="age"><?php
																	$matresult = mysqli_query($sqlcon, "SELECT * FROM `stmatall` where stid='".$stinfores['stid']."'");
																	$color = "purple";
										...
										<select multiple="multiple" size="10" name="duallistbox[]" id="form-field-13">
											<?php
												$result2 = mysqli_query($sqlcon, "SELECT * FROM `stmatall` where stid=$profileid");
												...
												?>												
											<option selected value="<?php echo $row2['matid'] ?>"> <?php echo $row2['matname']." - الترم ".$row2['matterm']." - السنة ".$row2['matyear'] ?> </option>
											<?php } ?>
											
											<?php
												$result2 = mysqli_query($sqlcon, "SELECT * FROM material WHERE matid NOT IN (SELECT material_matid FROM `stmat` where students_stid=$profileid AND status=1)");
												while ($row2 = $result2->fetch_assoc()) {
												unset($id2, $name2);
												$matid = $row2['matid'];
												$matname = $row2['matname']; 
