...
<html lang="en">
	<head>
		...
		<![endif]-->
		<?php require 'assets/redi/sqlcon.php'; ?>
									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php 
														$result4 = mysqli_query($sqlcon, "SELECT * FROM `absall`");
								...
								<div id="modal-add" class="modal fade" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form class="form-horizontal" method="post" action="assets/redi/insertabs.php">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-3"> المادة </label>
													<div class="col-sm-8">
														<select class="multiselect" id="form-field-3" name="material_matid">
															<?php
																require 'assets\redi\sqlcon.php';
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-4"> الطلاب </label>
													<div class="col-sm-8">
														<select class="multiselect" id="form-field-4" name="students_stid[]" multiple="">
															<?php
																require 'assets\redi\sqlcon.php';
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<div class="input-group">
															<input class="form-control date-picker" id="form-field-5" type="text" data-date-format="yyyy-mm-dd" name="date"/>
