									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php 
														$result4 = mysqli_query($sqlcon, "SELECT * FROM `professors`");
														while($row4 = mysqli_fetch_assoc($result4))
															{	
													?>
													<tr>
														<td><a class="green" href="prprofile.php?profileid=<?php echo $row4['prid'] ?>"><?php echo $row4['prname'] ?></a></td>
														<td><?php echo $row4['prmob'] ?></td>
														<td><?php echo $row4['prtel'] ?></td>
														<td><?php echo $row4['premail'] ?></td>
														<td>
															<style>
															...
															<p class="big">
															<?php
																$matresult = mysqli_query($sqlcon, "SELECT * FROM `prmatall` where prid='".$row4['prid']."'");
																$color = "purple";
														...
														<td><?php
																...
																elseif($row4['prbalance'] < 0):
																	$varb='<span class="btn btn-xs btn-danger">';
																elseif($row4['prbalance'] == 0):
																	$varb='<span class="btn btn-xs btn-warning">';
																endif;
																echo $varb.$row4['prbalance'];?></span>
														</td>
														<td>
															<div class="hidden-sm hidden-xs btn-group">
																<a class="green" href="prprofile.php?profileid=<?php echo $row4['prid'] ?>">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
					bAutoWidth: false,
					"aoColumns": [
					  null,{ "bSortable": false }, null, { "bSortable": false }, { "bSortable": false }, null,
					  { "bSortable": false }
					],
					"aaSorting": [],
