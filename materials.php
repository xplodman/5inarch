									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php 
														$result4 = mysqli_query($sqlcon, "SELECT * FROM `material`");
														while($row4 = mysqli_fetch_assoc($result4))
															{	
													?>
													<tr>
														<td><a class="green" href="matprofile.php?profileid=<?php echo $row4['matid'] ?>"><?php echo $row4['matname'] ?></a></td>
														<td><?php echo $row4['matyear'] ?></td>
														<td><?php echo $row4['matterm'] ?></td>
														<td><?php
															$result=mysqli_query($sqlcon, "SELECT * FROM `prmatall` where `matid`=$row4[matid]");
															while($prmatinfores = mysqli_fetch_assoc($result))
																						{	
																					if (!empty($prmatinfores)) {
															?>
															<a class="green" href="prprofile.php?profileid=<?php echo $prmatinfores['prid'] ?>"><?php echo $prmatinfores['prname'] .'<br>'?></a>
															<?php }};?>
														</td>
														<td>
															<?php
														...
														<td><span id="age"><?php 
															$studentscount=mysqli_query($sqlcon, "SELECT * FROM `stmatall` where `matid`=$row4[matid]");
