					...
					<div class="page-content">
							...
							if (isset($_GET['backresult']))
						{
							...
							if ($backresult ==  "1") {
								...
								$result=mysqli_query($sqlcon, "SELECT * FROM `material` where `matid`=$profileid");
								while($matinfores = mysqli_fetch_assoc($result))
															{	
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												<span class="profile-picture">
													<img id="avatar" onerror="this.src='assets/images/gallery/thumb-3.jpg'" src="assets/images/materials/<?php echo $matinfores['matid'] ;?>.jpg" />
												</span>
												<div class="space-4"></div>
											</div>
										</div>
										<div class="col-xs-12 col-sm-9">
										<form method="post" action="assets/redi/editmat.php?profileid=<?php echo $profileid?>">
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													<div class="profile-info-name">أسم المحاضر </div>

													<div class="profile-info-value">
														<?php
														$result=mysqli_query($sqlcon, "SELECT * FROM `prmatall` where `matid`=$profileid");
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> رقم المحاضر  </div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> عدد الطلاب الدارسين </div>

													<div class="profile-info-value">
														<span id="age">
															<?php 
																$result=mysqli_query($sqlcon, "Select Count(stmatall.matid) as Count From stmatall Where stmatall.matid =$profileid");
