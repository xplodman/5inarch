...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>الطلبة الخوارج - 5inArch</title>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="xStudents.php">xStudents</a>
							</li>
						</ul><!-- /.breadcrumb -->
					</div>
									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php 
														$result4 = mysqli_query($sqlcon,"select t1.* from students t1 where t1.sttype2 in ('c','e') or t1.styear in ('5')"
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				.DataTable( {
					bAutoWidth: false,
					"aoColumns": [
					  null, null, null, null,null, { "bSortable": false }, { "bSortable": false }, null
					],
					"aaSorting": [],
