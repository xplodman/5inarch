						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
									...
									$result=mysqli_query($sqlcon, "SELECT * FROM `tickets` where `tiid`=$receiptid");
									while($receiptresult = mysqli_fetch_assoc($result))
										{
											if($receiptresult['titype'] == '1'):
												?>
													<form class="form-horizontal" method="post" action="assets/redi/edittiplus.php?receiptid=<?php echo $receiptid ?>">
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> نوع الإيصال </label>
															<div class="col-sm-8">
																<input type="text" class="input-sm" disabled value="<?php echo "إستلام"?>"/>
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<div class="input-group">
																	<input class="form-control date-picker" id="form-field-5" type="text" data-date-format="yyyy-mm-dd" name="realdate" value="<?php echo $receiptresult['tirealdate']?>"/>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input name="reason" type="radio" class="ace" value="p1" <?php if($receiptresult['tireason']=="p1") echo 'checked="checked"'; ?>/>
																<span class="lbl"> كورس</span>
																&nbsp; &nbsp; &nbsp; &nbsp;
																<input name="reason" type="radio" class="ace" value="p2" <?php if($receiptresult['tireason']=="p2") echo 'checked="checked"'; ?>/>
																<span class="lbl"> مذكرات</span>
																&nbsp; &nbsp; &nbsp; &nbsp;
																<input name="reason" type="radio" class="ace" value="p3" <?php if($receiptresult['tireason']=="p3") echo 'checked="checked"'; ?>/>
																<span class="lbl"> مراجعة نهائية</span>
																&nbsp; &nbsp; &nbsp; &nbsp;
																<input name="reason" type="radio" class="ace" value="p4" <?php if($receiptresult['tireason']=="p4") echo 'checked="checked"'; ?>/>
											...
											elseif($receiptresult['titype'] == '2'):
												?>
													...
													<form class="form-horizontal" method="post" action="assets/redi/edittiminus.php?receiptid=<?php echo $receiptid ?>">
													<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> نوع الإيصال </label>
															<div class="col-sm-8">
																<input type="text" class="input-sm" disabled value="<?php echo "صرف"?>"/>
															</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> رقم الإيصال </label>
													...
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-4"> الصارف </label>
														<div class="col-sm-8">
															<select class="multiselect" id="form-field-4" name="donor">
																<?php
																	$result2 = mysqli_query($sqlcon, "SELECT * FROM `professors`");
												...
												<?php
											elseif($receiptresult['titype'] == '25' or $receiptresult['titype'] == '50'):
												?>
													<form class="form-horizontal" method="post" action="assets/redi/editaid.php?receiptid=<?php echo $receiptid ?>">
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> نوع الإيصال </label>
															<div class="col-sm-8">
																<input type="text" class="input-sm" disabled value="<?php echo "دعم"?>"/>
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> رقم الإيصال </label>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input name="titype" type="radio" class="ace" value="50" <?php if($receiptresult['titype']=="50") echo 'checked="checked"'; ?>/>
																<span class="lbl">50%</span>
																&nbsp; &nbsp; &nbsp; &nbsp;
																<input name="titype" type="radio" class="ace" value="25" <?php if($receiptresult['titype']=="25") echo 'checked="checked"'; ?>/>
																<span class="lbl">25%</span>
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> قيمة   الدعم </label>
															<div class="col-sm-8">
																<input type="text" class="input-sm" name="amount" value="<?php echo $receiptresult['tiamount']?>"/>
															</div>
														</div>
