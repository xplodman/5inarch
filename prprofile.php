					...
					<div class="page-content">
							...
							if (isset($_GET['backresult']))
						{
							...
							if ($backresult ==  "1") {
								...
								$result=mysqli_query($sqlcon, "SELECT * FROM `professors` where `prid`=$profileid");
								while($profinfores = mysqli_fetch_assoc($result))
															{	
													?>								
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div>
									<form method="post" action="assets/redi/editpr.php?profileid=<?php echo $profileid?>" method="post">
										<div id="user-profile-1" class="user-profile row">
											<div class="col-xs-12 col-sm-3 center">
												<div>
													<div class="space-12"></div>
													<span class="profile-picture">
														<img id="avatar" onerror="this.src='assets/images/avatars/profile-pic.jpg'" src="assets/images/avatars/<?php echo $profinfores['prid'] ;?>.jpg" />
													</span>
												...
												<div class="profile-user-info profile-user-info-striped">
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<input value="<?php echo $profinfores['prname'] ;?>" type="text" class="form-control" name="prname" >
														</div>
													</div>
													...
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<input value="<?php echo $profinfores['prmob'] ;?>" type="text" class="form-control" name="prmob" >
														</div>
													</div>
													
													<div class="profile-info-row">
														<div class="profile-info-name"> رقم آخر </div>

														<div class="profile-info-value">
															<input value="<?php echo $profinfores['prtel'] ;?>" type="text" class="form-control" name="prtel" >
														</div>
													</div>
													
													<div class="profile-info-row">
														<div class="profile-info-name"> أسم ولي الأمر </div>

														<div class="profile-info-value">
															<input value="<?php echo $profinfores['prparentname'] ;?>" type="text" class="form-control" name="prparentname" >
														</div>
													</div>
													
													<div class="profile-info-row">
														<div class="profile-info-name"> رقم ولي الأمر </div>

														<div class="profile-info-value">
															<input value="<?php echo $profinfores['prparentmob'] ;?>" type="text" class="form-control" name="prparentmob" >
														</div>
													</div>
													...
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<input value="<?php echo $profinfores['premail'] ;?>" type="text" class="form-control" name="premail" >
														</div>
													</div>
													...
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<span><?php
																	if($profinfores['prbalance'] > 0):
																		$varb='<a href="" class="btn btn-xs btn-success">';
																	elseif($profinfores['prbalance'] < 0):
																		$varb='<a href="" class="btn btn-xs btn-danger">';
																	elseif($profinfores['prbalance'] == 0):
																		$varb='<a href="" class="btn btn-xs btn-warning">';
																	endif;
																	echo $varb.$profinfores['prbalance'];?></a>
														</div>
													</div>
													
													<div class="profile-info-row">
														<div class="profile-info-name"> المواد </div>

														<div class="profile-info-value">
															<span id="age"><?php
																	$matresult = mysqli_query($sqlcon, "SELECT * FROM `prmatall` where prid='".$profinfores['prid']."'");
																	$color = "purple";
										...
										<select multiple="multiple" size="10" name="duallistbox_demo1[]" id="form-field-13">
											<?php
												$result2 = mysqli_query($sqlcon, "SELECT * FROM `prmatall` where prid=$profileid");
											...
											<?php
												$result2 = mysqli_query($sqlcon, "SELECT * FROM material WHERE matid NOT IN (SELECT material_matid FROM `prmat` where professors_prid=$profileid)");
												while ($row2 = $result2->fetch_assoc()) {
												unset($id2, $name2);
												$matid = $row2['matid'];
												$matname = $row2['matname']; 
