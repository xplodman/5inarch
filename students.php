								...
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="clearfix">
											...
											<a href="absence.php" class="btn btn-white btn-info btn-bold">
												<i class="ace-icon fa fa-calendar-check-o"></i>
													<b>الغياب</b></font>
											</a>
											<a href="#modal-edit" class="btn btn-white btn-info btn-bold" data-toggle="modal">
												<i class="ace-icon fa fa-pencil-square-o"></i>
													<b>تعديل طلاب متطور</b></font>
											</a>
											<a href="xstudents.php" class="btn btn-white btn-info btn-bold">
												<i class="ace-icon fa fa-thumbs-o-down"></i>
													<b>الطلاب الخوارج</b></font>
											</a>
											
										</div>
										<div class="table-header">
											نتائج البحث عن الطلبة
										</div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php 
														$result4 = mysqli_query($sqlcon,"select t1.* from students t1 where t1.sttype2 not in ('c','e') and t1.styear not in ('5')");
													...
													<tr>
														...
														<td><?php
																if($row4['stterm'] == 1):
																	echo "الأول";
																elseif($row4['stterm'] == 2):
																	echo "الثاني";
																elseif($row4['stterm'] == 3):
																	echo "صيف";	
																endif;
															?>
														</td>
														...
														<td><p class="big">
															<?php
																$matresult = mysqli_query($sqlcon, "SELECT * FROM `stmatall` where stid='".$row4['stid']."'");
																$color = "purple";
								...
								<div id="modal-add" class="modal fade" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form class="form-horizontal" method="post" action="assets/redi/insertst.php">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select multiple="multiple" size="16" name="material_matid1[]" id="form-field-13">
															<?php
																require 'assets\redi\sqlcon.php';
																$result2 = mysqli_query($sqlcon, "SELECT * FROM `material`");
								...
								<div id="modal-edit" class="modal fade" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form class="form-horizontal" method="post" action="assets/redi/multiedit.php">
												<div class="form-group">
													<label class="col-sm-1 control-label no-padding-right" for="form-field-3"> المواد </label>
													<div class="col-sm-10">
													
														<select multiple="multiple" size="16" name="material_matid[]" id="form-field-13">
															<?php
																require 'assets\redi\sqlcon.php';
																$result2 = mysqli_query($sqlcon, "SELECT * FROM `material`");
																while ($row2 = $result2->fetch_assoc()) {
												...
												<div class="form-group">
													<label class="col-sm-1 control-label no-padding-right" for="form-field-4"> الطلاب </label>
													<div class="col-sm-10">
														<select multiple="multiple" size="16" name="students_stid[]" id="form-field-13">
															<?php
																require 'assets\redi\sqlcon.php';
												...
												<div class="form-group">
													<label class="col-sm-1 control-label no-padding-right" for="form-field-4"> السنة </label>
													<div class="col-sm-10">
														<input name="styear" type="radio" class="ace" value="1"  />
														<span class="lbl"> الأولى</span>
														&nbsp;&nbsp;
												...
												<div class="form-group">
													<label class="col-sm-1 control-label no-padding-right" for="form-field-4"> الترم </label>
													<div class="col-sm-10">
														<input name="stterm" type="radio" class="ace" value="1" />
														<span class="lbl"> الأول</span>
														&nbsp;&nbsp;
												...
												<div class="form-group">
													<label class="col-sm-1 control-label no-padding-right" for="form-field-4"> النوع </label>
													<div class="col-sm-10">
														<input name="sttype2" type="radio" class="ace" value="A" />
														<span class="lbl"> باقي إعادة</span>
														&nbsp;&nbsp;
														...
														<span class="lbl"> مراجعة نهائية</span>
														&nbsp;&nbsp;
														<input name="sttype2" type="radio" class="ace" value="E" />
														<span class="lbl"> منسحب</span>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-1 control-label no-padding-right" for="form-field-8">  الرصيد </label>
													<div class="col-sm-8">
														<input type="text" class="input-sm" id="spinner4" name="balance" value="-650"/>
													</div>
												</div>
												<div class="clearfix form-actions">
													<div class="col-md-offset-3 col-md-9">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				.DataTable( {
					bAutoWidth: false,
					"aoColumns": [
					  null, null, null, null,null,null, { "bSortable": false }, { "bSortable": false }, null
					],
					"aaSorting": [],
